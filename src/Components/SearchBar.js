  ...
  return (
    <div className='pt-[45%] md:pt-[10%] lg:md:pt-[10%] flex justify-center'>
      <form className=' w-[90%] md:w-1/2 lg:md:w-1/2 bg-black grid grid-cols-12 rounded-md' onSubmit={(e)=>{e.preventDefault()}}>
        ...
        <button onClick={handleGptSearchClick} className='py-0 md:py-2 lg:py-2 px-4 bg-[#9b69ff] col-span-4 m-4 text-white rounded-md text-sm md:text-lg lg:text-lg '>{lang[langKey].search}</button>
      </form>
    </div>
  )
}
